// src/main.js
/**
 * Main entry point for ProCryptoFramework application
 */
...
class ProCryptoFramework {
    /**
     * Create a new ProCryptoFramework instance
...
module.exports = ProCryptoFramework;
...
if (require.main === module) {
    ...
    const app = new ProCryptoFramework({
        input: args.input,
        output: args.output,
